...
template="""
     You are an AI chatbot that responds human queries regarding pizzas.
Human: {human_input}
AI:
"""
...
result1 = chain.invoke("I want to add  the pizza 'Jumbo' for 17.89")
print(result1)
result2 = chain.invoke("How much does the following pizzas cost  ['Jumbo','Salami'] ")
print(result2)
